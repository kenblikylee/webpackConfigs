...
module.exports = class extends Generator {
  ...
  initializing() {
    ...
    const toIdenAst = i =>
      j(i).nodes()[0].program.body[0].expression.elements[0];
    ...
    root
      ...
      .at(-1)
      .__paths[0].value.elements.push(toIdenAst(`[${this.options.name}]`));
    this.source = prettier.format(root.toSource());
  }

  writing() {
    fs.writeFileSync(this.destinationPath("src/main.js"), this.source, {
      encoding: "utf-8"
    });
  }
};
